...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  15392 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - 118875 pixels (ratio 0.06 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 90687 pixels (ratio 0.04 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 15658 pixels (ratio 0.01 of all image pixels) are different.
