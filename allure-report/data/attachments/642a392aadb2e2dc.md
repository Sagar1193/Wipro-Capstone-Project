...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  15423 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - fonts loaded
  - 124338 pixels (ratio 0.06 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 60240 pixels (ratio 0.03 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 63406 pixels (ratio 0.03 of all image pixels) are different.
