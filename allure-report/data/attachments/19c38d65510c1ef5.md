...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  12378 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: dashboard-page.png

Call log:
  - Expect "toHaveScreenshot(dashboard-page.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 1280px by 1802px, received 1270px by 1802px. 121017 pixels (ratio 0.06 of all image pixels) are different.
  - waiting 100ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 89178 pixels (ratio 0.04 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - Expected an image 1270px by 1802px, received 1280px by 1802px. 32557 pixels (ratio 0.02 of all image pixels) are different.
        ...
        - generic [ref=e257]:
          - generic [ref=e258]:
            - generic [ref=e259] [cursor=pointer]:
              ...
              - generic [ref=e262]:
                - paragraph [ref=e263]: admin sss raj
                - paragraph [ref=e264]: 2026-24-05 04:10 PM
            - separator [ref=e265]
            - paragraph [ref=e266]: Excited for testing
          - generic [ref=e267]:
            - generic [ref=e268] [cursor=pointer]:
              - img "profile picture" [ref=e270]
              - generic [ref=e271]:
                - paragraph [ref=e272]: admin sss raj
                - paragraph [ref=e273]: 2026-24-05 04:10 PM
            - separator [ref=e274]
            - paragraph [ref=e275]: Excited for testing
          - generic [ref=e276]:
            - generic [ref=e277] [cursor=pointer]:
              - img "profile picture" [ref=e279]
              - generic [ref=e280]:
                - paragraph [ref=e281]: admin sss raj
                - paragraph [ref=e282]: 2026-24-05 04:10 PM
            - separator [ref=e283]
            - paragraph [ref=e284]: Excited for testing
          - generic [ref=e285]:
            - generic [ref=e286] [cursor=pointer]:
              - img "profile picture" [ref=e288]
              - generic [ref=e289]:
                - paragraph [ref=e290]: admin sss raj
                - paragraph [ref=e291]: 2026-24-05 03:38 PM
            - separator [ref=e292]
          ...
          - generic [ref=e295]:
            - generic [ref=e296] [cursor=pointer]:
              ...
              - generic [ref=e299]:
                - paragraph [ref=e300]: admin sss raj
                - paragraph [ref=e301]: 2026-24-05 03:37 PM
            - separator [ref=e302]
            - paragraph [ref=e303]: "Hi All; Linda has been blessed with a baby boy! Linda: With love, we welcome your dear new baby to this world. Congratulations!"
      - generic [ref=e305]:
        - generic [ref=e306]:
