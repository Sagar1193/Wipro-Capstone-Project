...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  15425 pixels (ratio 0.01 of all image pixels) are different.
...
Call log:
  ...
  - waiting for fonts to load...
  - fonts loaded
  - 29696 pixels (ratio 0.02 of all image pixels) are different.
  - waiting 250ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 87731 pixels (ratio 0.04 of all image pixels) are different.
  - waiting 500ms before taking screenshot
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 5308 pixels (ratio 0.01 of all image pixels) are different.
